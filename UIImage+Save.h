...
//  ProWatermarkMaker
//
//  This is a simply category to easily save an UIImage to the photos album.
//
//  Created by Barbara Rodeker on 4/21/14.
//
...
typedef void (^UIImageOnSaveErrorBlock)(NSError *);
